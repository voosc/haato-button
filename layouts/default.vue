      ...
      <v-footer :fixed="false">
        <div>
          <div style="vertical-align: middle;">
            ...
            <span>
              <a href="https://space.bilibili.com/157389653" target="_blank" rel="noreferrer">
                {{ $t('site.footer.union') }}
              </a>
            </span>
            <span>
            ...
            <v-btn
              icon
              href="https://github.com/voosc/haato-button"
              target="_blank"
      ...
      nav_items: [
        {
          ...
          title: 'Youtube',
          to: 'https://www.youtube.com/channel/UC1CfXB_kRs3C-zaeTG3oGyg?sub_confirmation=1'
        },
        {
          icon: '/img/twitter-fill.svg',
          title: 'Twitter',
          to: 'https://twitter.com/akaihaato'
        },
        {
          icon: '/img/bilibili-fill.svg',
          title: 'Bilibili',
          to: 'https://space.bilibili.com/339567211'
        }
      ],
      external_cn: [
        {
          icon: 'alpha_b_box',
          title: '赤井心保护协会',
          to: 'https://space.bilibili.com/157389653'
        }
      ]
    };
  },
